...
def sendproppermesage(url,productname,productprice,message,price,thumbnail,fields=[]):
 wh = Webhook("https://discordapp.com/api/webhooks/451547896438063141/K_cwyhz6Hgnz4-Qf7J-K1PDrFQrB7uw7lYQRTm54FzDRKM1pkuY6EHwZvpwZkoCxk_hZ",msg=message,title=productname,title_url=url,thumbnail=thumbnail,desc=price)
 wh.post()
sendproppermesage("https://www.target.com/p/boys-funko-batman-robin-short-sleeve-t-shirt-with-toy-gray/-/A-53244001","boys-funko-batman-robin-short-sleeve-t-shirt-with-toy-gray","14.99","this is a sample message with a product embedded","14.99"+" $\n "+"  __Stock: False__\n Site: Target ","https://target.scene7.com/is/image/Target/53224564?wid=1400",fields=["test1","test2"])
