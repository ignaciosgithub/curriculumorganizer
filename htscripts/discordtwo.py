...
def sendproppermesage(url,productname,productprice,message,price,thumbnail,fields=[]):
 ...
 wh.post()
sendproppermesage("https://www.google.com","boys-funko-batman-robin-short-sleeve-t-shirt-with-toy-gray","14.99","this is a sample message with a product embedded","14.99"+" $\n "+"  __Stock: False__\n Site: Target ","https://www.google.com",fields=["test1","test2"])
